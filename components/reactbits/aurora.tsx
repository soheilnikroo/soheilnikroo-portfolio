...
// Adapted from React Bits (https://reactbits.dev) — "Aurora". Named export, TS.
...
export function Aurora({
  ...
  React.useEffect(() => {
    ...
    const initialStops = (propsRef.current.colorStops ?? colorStops).map((hex) => {
    ...
    const update = (t: number) => {
      ...
      program.uniforms.uColorStops.value = (current.colorStops ?? colorStops).map((hex) => {
        const c = new Color(hex);
        return [c.r, c.g, c.b];
      });
