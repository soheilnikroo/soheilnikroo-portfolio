  ...
  nodes: [
    {
      ...
      category: "language",
      level: 5,
      summary: "Typed end-to-end, strict by default.",
    },
    {
      id: "react",
      label: "React",
      category: "framework",
      level: 5,
      summary: "Server & client components, hooks, Suspense.",
    },
    {
      id: "nextjs",
      label: "Next.js",
      category: "framework",
      level: 5,
      summary: "App Router, RSC, streaming, edge.",
    },
    {
      id: "tailwind",
      label: "Tailwind CSS",
      category: "design",
      level: 5,
      summary: "Token-driven, design-system friendly.",
    },
    {
      id: "motion",
      label: "Motion",
      category: "framework",
      level: 4,
      summary: "Scroll-driven & physics-based animation.",
    },
    {
      id: "node",
      label: "Node.js",
      category: "platform",
      level: 4,
      summary: "APIs, tooling, server actions.",
    },
    {
      id: "design-systems",
      ...
      category: "design",
      level: 4,
      summary: "Tokens, primitives, documentation.",
    },
    {
      id: "accessibility",
      label: "Accessibility",
      category: "practice",
      level: 4,
      summary: "WCAG, keyboard, reduced-motion.",
    },
    {
      id: "testing",
      label: "Testing",
      category: "practice",
      level: 4,
      summary: "Vitest, RTL, Playwright, axe.",
    },
    {
      id: "architecture",
      label: "Architecture",
      category: "practice",
      level: 4,
      summary: "Clean layering, pragmatic boundaries.",
    },
    {
      id: "postgres",
      label: "PostgreSQL",
      category: "platform",
      level: 3,
      summary: "Modeling, queries, migrations.",
    },
    {
      id: "figma",
      label: "Figma",
      category: "design",
      level: 3,
      summary: "Design hand-off & prototyping.",
    },
  ],
  edges: [
