...
/**
 * Primary content in *Exprience → Primary*
 */
export interface ExprienceSliceDefaultPrimary {
  /**
   * Heading field in *Exprience → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: exprience.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  heading: prismic.KeyTextField;
}
...
/**
 * Primary content in *Exprience → Items*
 */
export interface ExprienceSliceDefaultItem {
  /**
   * Title field in *Exprience → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: exprience.items[].title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;

  /**
   * Time Period field in *Exprience → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: exprience.items[].time_period
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  time_period: prismic.KeyTextField;

  /**
   * Instiution field in *Exprience → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: exprience.items[].instiution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  instiution: prismic.KeyTextField;

  /**
   * Description field in *Exprience → Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: exprience.items[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
}
...
/**
 * Default variation for Exprience Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExprienceSliceDefault = prismic.SharedSliceVariation<
  'default',
  Simplify<ExprienceSliceDefaultPrimary>,
  Simplify<ExprienceSliceDefaultItem>
>;

/**
 * Slice variation for *Exprience*
 */
type ExprienceSliceVariation = ExprienceSliceDefault;

/**
 * Exprience Shared Slice
 *
 * - **API ID**: `exprience`
 * - **Description**: Exprience
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExprienceSlice = prismic.SharedSlice<
  'exprience',
  ExprienceSliceVariation
>;
...
declare module '@prismicio/client' {
  ...
  namespace Content {
    export type {
      ...
      ExprienceSlice,
      ExprienceSliceDefaultPrimary,
      ExprienceSliceDefaultItem,
      ExprienceSliceVariation,
      ExprienceSliceDefault,
      HeroSlice,
